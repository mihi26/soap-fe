          ...
          <div className="col-12 ">
            ...
            <div className="tab-content tab-space">
                ...
                <div className="row mt-5">
                  <div className="col-12 col-lg-6 mb-lg-0 mb-4 pe-lg-10">
                    ...
                    <p>
                      ...
                      and I'm not trying my hardest, and I'm not trying to do
                  ...
                  <div className="col-12 col-lg-6 mb-lg-0 mb-4">
                    <img
                      ...
                      src="https://images.unsplash.com/photo-1549400854-b4300f444934?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1200&q=80"
                      alt=""
                    />
                  </div>
                </div>
              ...
              >
                <div className="row mt-5">
                  <div className="col-12 col-lg-6 mb-lg-0 mb-4">
                    <h5 className="mt-5 mb-4">Material Design</h5>
                    <p>
                      ...
                      be the greatest you.
                      <br />
                      Would you believe in what you believe in, if you were the
                      only one who believed it? People are so scared to lose
              ...
              >
                <div className="row mt-5">
                  <div className="col-12 col-lg-6 mb-lg-0 mb-4">
                    <h5 className="mt-5 mb-4">Considerations</h5>
                    <p>
              ...
              >
                <div className="row mt-5">
                  <div className="col-12 col-lg-6 mb-lg-0 mb-4">
                    <h5 className="mt-5 mb-4">Included</h5>
                    <p>
                      ...
                      <br />
                      If you have the opportunity to play this game of life you
