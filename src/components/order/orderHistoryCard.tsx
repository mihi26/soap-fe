    ...
    <>
      <div className="bg-gray-100 rounded-3 mt-5 mb-4">
        <div className="d-block d-md-flex justify-content-between align-items-center">
          ...
          <button
            className="btn btn-white mb-md-0 ms-4 md-md-0 me-4"
                    ...
                    <div className="row justify-content-md-between">
                      <div className="col-md-4">
                        <h4 className="mt-5 text-start">
                          Invoice no. <br />
                          <small className="mr-2">#XK98321111</small>
                        </h4>
                      </div>
                      <div className="col-lg-4 col-md-5">
                        <div className="d-flex align-items-center mt-5 ms-auto float-end">
                          <div className="text-sm me-3 font-weight-bold">
                            Invoice date:
                          </div>
        ...
        <table className="table">
          <thead>
            <tr>
              <th
                scope="col"
                className="text-secondary text-xs font-weight-semibold opacity-7 border-light ps-2"
              >
                Product
              </th>
              <th
              ...
              <th
                scope="col"
                className="text-secondary text-xs font-weight-semibold opacity-7 border-light ps-2 text-end"
              >
                Info
              </th>
            </tr>
