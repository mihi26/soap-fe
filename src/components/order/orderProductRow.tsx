...
export default function OrderSummary({ product, status, dateModified }: Props) {
  return (
    <>
      <tr>
        <th
          scope="row"
          className="d-flex align-items-center text-sm text-secondary py-3"
        >
          <img
            className="w-20 w-lg-10 rounded-3 shadow-xs"
